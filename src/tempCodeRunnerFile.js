...
import LoginSignup from "./LoginSignup"; // Assuming this component exists
      ...
      >
        <div>
          ...
          >
            ...
            {/* Nav Links */}
            <div>
             <Link to="/" style={{  backgroundColor: "#457b9d",
                color: "white",
                padding: "2px",
                border: "none",
                borderRadius: "5px",
             ...
             <Link to="/login" style={{backgroundColor: "#457b9d",
                color: "white",
                padding: "2px",
                border: "none",
                borderRadius: "1px",
              ...
              <div>
                ...
                >
                  ...
                  <p style={{ fontSize: "1.3em" }}>
                    Reliable, Quality Medicines at Your Doorstep
                  </p>
                </header>
